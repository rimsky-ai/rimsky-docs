<!-- AUTOGENERATED by rimsky-docs-vendor-examples from rimsky-core examples/ at lib/protocols v0.8.0.
     Do not edit here; edit examples/ in rimsky-core and re-run /build-docs. -->
<!-- This code reflects rimsky lib/protocols v0.8.0. For another pin, read the package at your tag. -->
