...
Rimsky's implementation lives in the public repository [`github.com/rimsky-ai/rimsky-core`](https://github.com/rimsky-ai/rimsky-core). The documentation here is generated and reconciled against that repository's latest release tag (currently **v0.4.0**); the prose is derived from the source and verified against it, but the source of truth is the repository, not these docs.
